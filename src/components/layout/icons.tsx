...
export function PlayLogoIcon(props: IconProps) {
...
export function LiveIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" {...props}>
      <path d="M12 3v3M8 5l1.5 2.5M16 5l-1.5 2.5" strokeLinecap="round" />
...
export function MoviesIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" {...props}>
      ...
      <path d="M7 9v6M7 9l3 3-3 3M17 9v6M17 9l-3 3 3 3" />
    </svg>
  );
}
